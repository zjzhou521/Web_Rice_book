...
const doUpload = (publicId, req, res, next) => {
	...
	// we create a pass-through stream to pipe the buffer
...
function getImage(req, res) {
	...
	res.send('Test:</br><form method="post" enctype="multipart/form-data">'
...
function setup(app) {
	...
	// this provides a form.  This is unneeded because
	// we have the upload on the frontend already.
    // but I provide it here for the in-class exercise example
